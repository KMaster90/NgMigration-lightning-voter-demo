...
/***/ "./public/home/createNewSession.ts":
/*!*****************************************!*\
  !*** ./public/home/createNewSession.ts ***!
  \*****************************************/
/***/ (() => {
...
angular.module('app').component('createNewSession', {
    ...
    controller: function (toastr, currentIdentity, sessionsService) {
        this.create = function () {
            ...
            sessionsService.createNewSession(newUserSession)
                .then(function (response) { return _this.userSessions.push(response); });
        };
    }
});
...
angular.module('app').service('auth', /** @class */ (function () {
...
/***/ "./public/security/currentIdentity.ts":
/*!********************************************!*\
  !*** ./public/security/currentIdentity.ts ***!
  \********************************************/
/***/ (() => {

angular.module('app').service('currentIdentity', /** @class */ (function () {
...
/***/ "./public/security/users.ts":
/*!**********************************!*\
  !*** ./public/security/users.ts ***!
  \**********************************/
/***/ (() => {

angular.module('app').service('users', /** @class */ (function () {
...
/***/ "./public/sessions/unreviewedSessionCount.ts":
/*!***************************************************!*\
  !*** ./public/sessions/unreviewedSessionCount.ts ***!
  \***************************************************/
/***/ (() => {

angular.module('app').service('unreviewedSessionCount', /** @class */ (function () {
    function UnreviewedSessionCount(sessionsService, currentIdentity) {
        this.value = 0;
    ...
    UnreviewedSessionCount.prototype.updateUnreviewedSessionCount = function () {
        ...
        this.sessionsService.getUnreviewedCount(this.currentIdentity.currentUser.id)
            .then(function (response) { return _this.value = response.count; });
    };
...
__webpack_require__(/*! ./vendor/jquery.min */ "./public/vendor/jquery.min.js");
__webpack_require__(/*! ./vendor/1.6.3/angular.min */ "./public/vendor/1.6.3/angular.min.js");
__webpack_require__(/*! ./vendor/1.6.3/angular-route.min */ "./public/vendor/1.6.3/angular-route.min.js");
__webpack_require__(/*! ./vendor/toastr.min */ "./public/vendor/toastr.min.js");
__webpack_require__(/*! ./toastr/toastr */ "./public/toastr/toastr.ts");
__webpack_require__(/*! ./app */ "./public/app.ts");
__webpack_require__(/*! ./routes */ "./public/routes.ts");
__webpack_require__(/*! ./admin/adminLogin */ "./public/admin/adminLogin.ts");
// import "./admin/results";
__webpack_require__(/*! ./admin/createUsers */ "./public/admin/createUsers.ts");
__webpack_require__(/*! ./admin/userList */ "./public/admin/userList.ts");
__webpack_require__(/*! ./admin/userDetails */ "./public/admin/userDetails.ts");
// import "./app/nav/nav";
__webpack_require__(/*! ./security/logout */ "./public/security/logout.ts");
__webpack_require__(/*! ./security/login */ "./public/security/login.ts");
__webpack_require__(/*! ./security/auth */ "./public/security/auth.ts");
__webpack_require__(/*! ./security/currentIdentity */ "./public/security/currentIdentity.ts");
__webpack_require__(/*! ./security/users */ "./public/security/users.ts");
// import "./app/home/home";
__webpack_require__(/*! ./home/createNewSession */ "./public/home/createNewSession.ts");
// import "./sessions/sessions";
__webpack_require__(/*! ./sessions/unreviewedSessionCount */ "./public/sessions/unreviewedSessionCount.ts");
// import "./app/sessions/sessionDetail";
// import "./app/sessions/sessionDetailWithVotes";
// import "./app/common/detailPanel";
__webpack_require__(/*! ./components/talkDuration */ "./public/components/talkDuration.ts");
__webpack_require__(/*! ./components/zoomIn */ "./public/components/zoomIn.ts");
